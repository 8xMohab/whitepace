...
interface IconProps {
  className?: string; // Accepts Tailwind class for color and other styles
  strokeWidth?: string;
}

function CheckCustomIcon({ className = "", strokeWidth = "4" }: IconProps) {
  return (
    <svg
      width="100%"
      height="100%"
    ...
    >
      <path
        ...
        stroke="currentColor" // Use currentColor for Tailwind classes to work
